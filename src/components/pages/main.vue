    ...
    <div class="w-full max-w-6xl  rounded-lg bg-green-300  bg-opacity-60  p-10 lg:p-20 mx-auto text-gray-800 relative md:text-left">
        <div class="md:flex items-center -mx-10">
            <div class="w-full md:w-1/2 px-10 mb-10 md:mb-0">
                <div class="relative">
                    <img :src='pic' v-for="pic in pic4a" class="w-full relative z-10" alt="#">
            ...
            <div class="w-full md:w-1/2 px-10">
                <div class="mb-10 main-text">
                    ...
                    <p class=" uppercase text-black text-xl">«Рик и Морти» — американский комедийный научно-фантастический анимационный сериал, созданный Джастином Ройландом и Дэном Хармоном и выпускаемый в рамках блока Adult Swim на телеканале Cartoon Network. Премьера сериала состоялась в декабре 2013 года. <br>Поздравляю, вы <span class="font-bold sd">{{ Math.abs(gamesNow) }}</span> посетитель! </p>
                </div>
                <div>
                    <div class="inline-block align-bottom ml-10 mr-6 mb-3 lg:mb-0">
                        <button class="bg-yellow-300 opacity-80 hover:opacity-100 text-yellow-900 hover:text-gray-900 rounded-full px-10 py-2 font-semibold"><i class="mdi mdi-cart -ml-2 mr-2"></i>Серии</button>
                    </div>
                    <div class="inline-block align-bottom ml-10 lg:ml-0">
